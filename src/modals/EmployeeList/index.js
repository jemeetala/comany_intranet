    ...
    <>
      ...
      >
        <div className="m-[auto] max-h-[97vh] overflow-y-auto">
          ...
          <Row className="bg-white_A700 border border-indigo_50 border-solid font-sourcesanspro items-start justify-end lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px] w-[98%]">
            ...
            <Button className="bg-white_A700 border border-gray_200 border-solid font-normal lg:ml-[406px] xl:ml-[464px] ml-[522px] 3xl:ml-[626px] xl:mt-[1px] lg:mt-[1px] mt-[2px] not-italic lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius4 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-center text-indigo_A200 w-[6%]">
              DashBoard
            </Button>
          ...
          <Column className="bg-white_A700 font-sourcesanspro justify-start lg:mt-[13px] xl:mt-[15px] mt-[17px] 3xl:mt-[20px] lg:p-[17px] xl:p-[20px] p-[23px] 3xl:p-[27px] rounded-radius4 shadow-bs w-[97%]">
            ...
            <Column className="bg-white_A700 border-bw05 border-gray_202 border-solid font-inter items-center justify-start lg:mb-[130px] xl:mb-[149px] mb-[168px] 3xl:mb-[201px] ml-[11px] 3xl:ml-[13px] lg:ml-[8px] xl:ml-[9px] lg:mr-[4px] xl:mr-[5px] mr-[6px] 3xl:mr-[7px] lg:mt-[21px] xl:mt-[24px] mt-[28px] 3xl:mt-[33px] pb-[103px] 3xl:pb-[123px] lg:pb-[80px] xl:pb-[91px] w-[99%]">
              <List
              ...
              >
                <Row className="items-center justify-evenly my-[0] w-[100%]">
                  <Image
                    ...
                    alt="Title"
                  />
                  <Column className="bg-gray_50 border-bw05 border-gray_202 border-solid items-start lg:p-[10px] xl:p-[11px] p-[13px] 3xl:p-[15px] w-[16%]">
                ...
                <Row className="items-center justify-evenly my-[0] w-[100%]">
                  <Image
                    ...
                    alt="Content"
                  />
                  <Column className="bg-white_A700 border-bw05 border-gray_202 border-solid items-start p-[11px] 3xl:p-[13px] lg:p-[8px] xl:p-[9px] w-[16%]">
