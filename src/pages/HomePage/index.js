  ...
  return (
    <>
      <Column className="bg-gray_100 font-segoeui items-center mx-[auto] lg:pb-[14px] xl:pb-[16px] pb-[19px] 3xl:pb-[22px] w-[100%]">
        <Row className="bg-white_A700 border border-bluegray_50 border-solid items-center lg:p-[10px] xl:p-[12px] p-[14px] 3xl:p-[16px] w-[100%]">
          <Img
            src="images/img_image2_2.png"
            className="lg:h-[25px] xl:h-[29px] h-[32px] 2xl:h-[33px] 3xl:h-[39px] lg:ml-[27px] xl:ml-[31px] ml-[35px] 3xl:ml-[42px] lg:w-[24px] xl:w-[28px] w-[32px] 3xl:w-[38px]"
            alt="image2"
          />
        ...
        <Stack className="bg-white_A700 border border-indigo_50 border-solid font-sourcesanspro lg:h-[56px] xl:h-[65px] h-[72px] 2xl:h-[73px] 3xl:h-[87px] mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] w-[98%]">
          <Row className="absolute h-[max-content] inset-[0] justify-center m-[auto] w-[95%]">
            <Text className="font-semibold lg:my-[6px] xl:my-[7px] my-[8px] 3xl:my-[9px] lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px] text-deep_purple_A200 w-[auto]">
              My DashBoard
            </Text>
            <Column className="bg-white_A700 border border-gray_200 border-solid lg:ml-[448px] xl:ml-[512px] ml-[576px] 3xl:ml-[691px] mt-[2px] lg:p-[5px] xl:p-[6px] p-[7px] 3xl:p-[8px] rounded-radius4 w-[7%]">
              <Text className="font-normal ml-[0] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-indigo_A200 w-[auto]">
                DashBoard
              </Text>
            </Column>
            <Column className="bg-white_A700 border border-gray_200 border-solid items-center mb-[2px] lg:ml-[15px] xl:ml-[17px] ml-[20px] 3xl:ml-[24px] lg:p-[5px] xl:p-[6px] p-[7px] 3xl:p-[8px] rounded-radius4 w-[7%]">
              <Text className="font-normal not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-indigo_A200 w-[auto]">
                Employee List
              </Text>
            </Column>
            <Column className="bg-white_A700 border border-gray_200 border-solid items-center lg:ml-[11px] xl:ml-[13px] ml-[15px] 3xl:ml-[18px] mt-[4px] lg:p-[4px] xl:p-[5px] p-[6px] 3xl:p-[7px] rounded-radius4 w-[6%]">
              <Text className="font-normal not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-indigo_A200 w-[auto]">
                Capabilities
              </Text>
            </Column>
          ...
          <Row className="absolute bg-white_A700 border border-indigo_50 border-solid items-center justify-end lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px] w-[100%]">
            <Text className="font-semibold lg:text-[15px] xl:text-[17px] text-[20px] 3xl:text-[24px] text-deep_purple_A200 w-[auto]">
              My DashBoard
            </Text>
            ...
            <Stack className="bg-red_600 lg:h-[28px] xl:h-[33px] h-[36px] 2xl:h-[37px] 3xl:h-[44px] lg:ml-[19px] xl:ml-[22px] ml-[25px] 3xl:ml-[30px] px-[11px] 3xl:px-[13px] lg:px-[8px] xl:px-[9px] rounded-radius19 w-[3%]">
              <Img
        ...
        >
          <Row className="items-center justify-between xl:my-[10px] my-[12px] 3xl:my-[14px] lg:my-[9px] w-[100%]">
            <Column className="bg-white_A700 lg:p-[18px] xl:p-[21px] p-[24px] 3xl:p-[28px] rounded-radius4 shadow-bs w-[49%]">
              ...
              <Stack className="lg:h-[201px] xl:h-[230px] h-[258px] 2xl:h-[259px] 3xl:h-[310px] lg:ml-[20px] xl:ml-[23px] ml-[26px] 3xl:ml-[31px] lg:mt-[24px] xl:mt-[28px] mt-[32px] 3xl:mt-[38px] w-[91%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  <Column className="lg:pr-[132px] xl:pr-[151px] pr-[170px] 3xl:pr-[204px] w-[65%]">
                    <Row className="items-center w-[100%]">
                      ...
                      <Img
                        ...
                        className="lg:h-[19px] xl:h-[22px] h-[24px] 2xl:h-[25px] 3xl:h-[29px] lg:ml-[11px] xl:ml-[13px] ml-[15px] 3xl:ml-[18px] w-[57%]"
                        alt="Line6"
                      />
                    </Row>
                    <Row className="items-center lg:mt-[118px] xl:mt-[135px] mt-[152px] 3xl:mt-[182px] w-[100%]">
                      <Column className="w-[36%]">
                        <Text className="font-bold lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-blue_600 w-[auto]">
                          50%
                        </Text>
                  ...
                  <Column className="items-center w-[35%]">
                    <Row className="items-center lg:pr-[17px] xl:pr-[20px] pr-[23px] 3xl:pr-[27px] rotate-[180deg] w-[100%]">
                      <Img
                        src="images/img_line9_1.png"
                        className="lg:h-[21px] xl:h-[25px] h-[27px] 2xl:h-[28px] 3xl:h-[33px] w-[64%]"
                        alt="Line9"
                      />
                      <Column className="xl:ml-[10px] ml-[12px] 3xl:ml-[14px] lg:ml-[9px] rotate-[180deg] w-[29%]">
                        <Text className="font-bold lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-blue_600 w-[auto]">
                          20%
                        </Text>
                        <Text className="font-normal lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_500 w-[auto]">
                    ...
                    <Row className="items-center lg:mt-[38px] xl:mt-[44px] mt-[50px] 3xl:mt-[60px] lg:pr-[17px] xl:pr-[20px] pr-[23px] 3xl:pr-[27px] w-[100%]">
                      <Line className="bg-bluegray_100 h-[110px] w-[64%]" />
                      <Column className="xl:ml-[10px] ml-[12px] 3xl:ml-[14px] lg:ml-[9px] w-[29%]">
                        <Text className="font-bold lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-blue_600 w-[auto]">
                          15%
                        </Text>
                        <Text className="font-normal lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-bluegray_500 w-[auto]">
                    ...
                    <Row className="items-center justify-between lg:mt-[38px] xl:mt-[43px] mt-[49px] 3xl:mt-[58px] pr-[1px] rotate-[180deg] w-[100%]">
                      <Img
                        ...
                        className="lg:h-[21px] xl:h-[25px] h-[27px] 2xl:h-[28px] 3xl:h-[33px] w-[57%]"
                        alt="Line9"
                      />
                      <Column className="w-[37%]">
                        <Text className="font-bold ml-[2px] rotate-[180deg] lg:text-[18px] xl:text-[21px] text-[24px] 3xl:text-[28px] text-blue_600 w-[auto]">
                          15%
                        </Text>
            ...
            <Column className="bg-white_A700 lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px] rounded-radius4 shadow-bs w-[49%]">
              ...
              <Row className="lg:mr-[6px] xl:mr-[7px] mr-[8px] 3xl:mr-[9px] lg:mt-[33px] xl:mt-[38px] mt-[43px] 3xl:mt-[51px] w-[99%]">
                <Text className="font-normal leading-[normal] mb-[105px] 3xl:mb-[126px] lg:mb-[81px] xl:mb-[93px] lg:mt-[55px] xl:mt-[63px] mt-[71px] 3xl:mt-[85px] rotate-[90deg] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_500 w-[3%]">
                  Total Candidates
                </Text>
                <Stack className="lg:h-[215px] xl:h-[246px] h-[276px] 2xl:h-[277px] 3xl:h-[332px] xl:ml-[10px] ml-[12px] 3xl:ml-[14px] lg:ml-[9px] w-[95%]">
                  ...
                  <Row className="absolute h-[max-content] inset-y-[0] items-end my-[auto] lg:px-[5px] xl:px-[6px] px-[7px] 3xl:px-[8px] right-[4%] w-[87%]">
                    ...
                    <Column className="items-center lg:pr-[35px] xl:pr-[40px] pr-[46px] 3xl:pr-[55px] w-[22%]">
                      <div className="bg-blue_600 lg:h-[182px] xl:h-[208px] h-[233px] 2xl:h-[234px] 3xl:h-[280px] w-[52%]"></div>
                      <Text className="font-semibold lg:mt-[10px] xl:mt-[12px] mt-[14px] 3xl:mt-[16px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_500 w-[auto]">
                        Screening
                      </Text>
                    </Column>
                    <Column className="items-center lg:mt-[60px] xl:mt-[69px] mt-[78px] 3xl:mt-[93px] lg:pr-[47px] xl:pr-[54px] pr-[61px] 3xl:pr-[73px] w-[25%]">
                      <div className="bg-blue_600 lg:h-[121px] xl:h-[138px] h-[155px] 2xl:h-[156px] 3xl:h-[187px] w-[49%]"></div>
                      <Text className="font-semibold lg:mt-[10px] xl:mt-[12px] mt-[14px] 3xl:mt-[16px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_500 w-[auto]">
                        Interviews
                      </Text>
                    </Column>
                    <Column className="h-[110px] 2xl:h-[111px] 3xl:h-[133px] lg:h-[86px] xl:h-[98px] lg:mt-[121px] xl:mt-[138px] mt-[156px] 3xl:mt-[187px] lg:pr-[59px] xl:pr-[68px] pr-[77px] 3xl:pr-[92px] w-[110px] 3xl:w-[132px] lg:w-[85px] xl:w-[97px]">
                      <div className="bg-blue_600 lg:h-[60px] xl:h-[69px] h-[77px] 2xl:h-[78px] 3xl:h-[93px] ml-[0] w-[97%]"></div>
                      <Text className="font-semibold lg:mt-[10px] xl:mt-[12px] mt-[14px] 3xl:mt-[16px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_500 w-[auto]">
                        Offer
                      </Text>
                    </Column>
                    <Column className="items-center lg:mt-[14px] xl:mt-[16px] mt-[18px] 3xl:mt-[21px] w-[6%]">
