  ...
  return (
    <>
      <Column className="bg-gray_100 font-segoeui items-center mx-[auto] lg:pb-[14px] xl:pb-[16px] pb-[19px] 3xl:pb-[22px] w-[100%]">
        ...
        <Row className="bg-white_A700 border border-gray_200 border-solid font-sourcesanspro justify-end lg:mt-[12px] xl:mt-[14px] mt-[16px] 3xl:mt-[19px] lg:p-[12px] xl:p-[14px] p-[16px] 3xl:p-[19px] w-[98%]">
          ...
          <Button
            className="common-pointer bg-white_A700 border border-gray_200 border-solid font-normal lg:ml-[373px] xl:ml-[427px] ml-[480px] 3xl:ml-[576px] mt-[2px] not-italic lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius4 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-center text-indigo_A200 w-[6%]"
            onClick={handleNavigate5}
          >
            DashBoard
          </Button>
          <Button
            className="common-pointer bg-white_A700 border border-gray_200 border-solid font-normal mb-[2px] lg:ml-[15px] xl:ml-[17px] ml-[20px] 3xl:ml-[24px] not-italic lg:py-[5px] xl:py-[6px] py-[7px] 3xl:py-[8px] rounded-radius4 lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-center text-indigo_A200 w-[7%]"
        ...
        <Column className="bg-white_A700 font-inder lg:mt-[13px] xl:mt-[15px] mt-[17px] 3xl:mt-[20px] lg:p-[4px] xl:p-[5px] p-[6px] 3xl:p-[7px] rounded-radius4 shadow-bs w-[98%]">
          <Text className="font-normal lg:ml-[14px] xl:ml-[16px] ml-[19px] 3xl:ml-[22px] xl:mr-[1064px] mr-[1197px] 3xl:mr-[1437px] lg:mr-[931px] lg:mt-[14px] xl:mt-[16px] mt-[19px] 3xl:mt-[22px] not-italic lg:text-[11px] xl:text-[13px] text-[15px] 3xl:text-[18px] text-black_900 w-[auto]">
            Employee Capability list
          </Text>
          <Stack className="font-inter lg:h-[343px] xl:h-[392px] h-[440px] 2xl:h-[441px] 3xl:h-[529px] lg:mb-[211px] xl:mb-[241px] mb-[272px] 3xl:mb-[326px] lg:ml-[21px] xl:ml-[24px] ml-[28px] 3xl:ml-[33px] lg:mt-[50px] xl:mt-[57px] mt-[65px] 3xl:mt-[78px] outline outline-[1px] outline-gray_202 w-[98%]">
            <div className="absolute lg:h-[298px] xl:h-[341px] h-[383px] 2xl:h-[384px] 3xl:h-[460px] outline outline-[1px] outline-gray_202 top-[0] w-[100%]"></div>
            <Column className="absolute bg-white_A700 border-bw05 border-gray_202 border-solid items-center w-[100%]">
              <Row className="items-center justify-evenly w-[100%]">
                <Text className="bg-white_A700 border-bw05 border-gray_202 border-solid font-bold lg:leading-[14px] xl:leading-[16px] leading-[18.00px] 2xl:leading-[18px] 3xl:leading-[21px] lg:pl-[17px] xl:pl-[19px] pl-[22px] 3xl:pl-[26px] lg:py-[10px] xl:py-[11px] py-[13px] 3xl:py-[15px] xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_900_87 tracking-ls1 w-[12%]">
                  Employees name
                </Text>
                <List
                  className="gap-[0] grid grid-cols-6 min-h-[auto] w-[75%]"
                  orientation="horizontal"
                >
                  <Row className="bg-white_A700 border-bw05 border-gray_202 border-solid items-center justify-between lg:p-[10px] xl:p-[11px] p-[13px] 3xl:p-[15px] w-[100%]">
                    <Text className="font-bold 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] ml-[9px] xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_900_87 tracking-ls1 w-[auto]">
                      select
                    </Text>
                    <Img
                      src="images/img_.png"
                      className="lg:h-[14px] xl:h-[17px] h-[18px] 2xl:h-[19px] 3xl:h-[22px] w-[6%]"
                      alt=""
                    />
                  </Row>
                  <Row className="bg-white_A700 border-bw05 border-gray_202 border-solid items-center justify-end lg:p-[10px] xl:p-[11px] p-[13px] 3xl:p-[15px] w-[100%]">
                    <Text className="font-bold xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_900_87 tracking-ls1 w-[auto]">
                      Select
                    </Text>
                    <Img
                      src="images/img__2.png"
                      className="lg:h-[14px] xl:h-[17px] h-[18px] 2xl:h-[19px] 3xl:h-[22px] 3xl:ml-[103px] lg:ml-[66px] xl:ml-[76px] ml-[86px] w-[6%]"
                      alt=""
                    />
                  </Row>
                  <Row className="bg-white_A700 border-bw05 border-gray_202 border-solid items-center justify-end lg:p-[10px] xl:p-[11px] p-[13px] 3xl:p-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 border-bw05 border-gray_202 border-solid lg:h-[35px] xl:h-[40px] h-[44px] 2xl:h-[45px] 3xl:h-[53px] w-[12%]"></div>
              </Row>
              <Row className="items-center justify-evenly w-[100%]">
                <Text className="bg-gray_50 border-bw05 border-gray_202 border-solid font-bold lg:leading-[14px] xl:leading-[16px] leading-[18.00px] 2xl:leading-[18px] 3xl:leading-[21px] lg:pl-[17px] xl:pl-[19px] pl-[22px] 3xl:pl-[26px] lg:py-[10px] xl:py-[11px] py-[13px] 3xl:py-[15px] xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_901 tracking-ls1 w-[12%]">
                  Employees name
                </Text>
                <Text className="bg-gray_50 border-bw05 border-gray_202 border-solid font-bold lg:leading-[14px] xl:leading-[16px] leading-[18.00px] 2xl:leading-[18px] 3xl:leading-[21px] pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] lg:py-[10px] xl:py-[11px] py-[13px] 3xl:py-[15px] xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_901 tracking-ls1 w-[12%]">
              ...
              >
                <Row className="items-center justify-evenly my-[0] w-[100%]">
                  <Text className="bg-white_A700 border-bw05 border-gray_202 border-solid font-normal lg:leading-[17px] xl:leading-[19px] leading-[22.00px] 2xl:leading-[22px] 3xl:leading-[26px] not-italic lg:pl-[17px] xl:pl-[19px] pl-[22px] 3xl:pl-[26px] py-[11px] 3xl:py-[13px] lg:py-[8px] xl:py-[9px] xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px] text-bluegray_901 tracking-ls1 w-[12%]">
                    Design
                  </Text>
                  <Column className="bg-white_A700 border-bw05 border-gray_202 border-solid p-[11px] 3xl:p-[13px] lg:p-[8px] xl:p-[9px] w-[12%]">
                  ...
                  <Text className="bg-white_A700 border-bw05 border-gray_202 border-solid font-normal lg:leading-[17px] xl:leading-[19px] leading-[22.00px] 2xl:leading-[22px] 3xl:leading-[26px] not-italic lg:pl-[17px] xl:pl-[19px] pl-[22px] 3xl:pl-[26px] py-[11px] 3xl:py-[13px] lg:py-[8px] xl:py-[9px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-light_blue_A700 tracking-ls1 w-[12%]">
                    Edit
                  </Text>
                </Row>
                <Row className="items-center justify-evenly my-[0] w-[100%]">
                  <Text className="bg-white_A700 border-bw05 border-gray_202 border-solid font-normal lg:leading-[17px] xl:leading-[19px] leading-[22.00px] 2xl:leading-[22px] 3xl:leading-[26px] not-italic lg:pl-[17px] xl:pl-[19px] pl-[22px] 3xl:pl-[26px] py-[11px] 3xl:py-[13px] lg:py-[8px] xl:py-[9px] lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-bluegray_901 tracking-ls1 w-[12%]">
                    Prototype
                  </Text>
                  <Column className="bg-white_A700 border-bw05 border-gray_202 border-solid p-[11px] 3xl:p-[13px] lg:p-[8px] xl:p-[9px] w-[12%]">
                    <Text className="bg-orange_50 border-bw05 border-orange_800 border-solid font-normal ml-[11px] 3xl:ml-[13px] lg:ml-[8px] xl:ml-[9px] lg:px-[6px] xl:px-[7px] px-[8px] 3xl:px-[9px] rounded-radius4 text-[11px] 3xl:text-[13px] lg:text-[8px] xl:text-[9px] text-orange_800 tracking-ls1 w-[auto]">
