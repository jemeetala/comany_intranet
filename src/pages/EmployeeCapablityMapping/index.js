  ...
  return (
    <>
      <Column className="bg-gray_100 font-segoeui items-center mx-[auto] lg:pb-[14px] xl:pb-[16px] pb-[19px] 3xl:pb-[22px] w-[100%]">
        ...
        <Column className="bg-white_A700 font-inder lg:mt-[13px] xl:mt-[15px] mt-[17px] 3xl:mt-[20px] lg:p-[11px] xl:p-[13px] p-[15px] 3xl:p-[18px] rounded-radius4 shadow-bs w-[98%]">
