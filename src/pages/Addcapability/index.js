...
const AddcapabilityPage = () => {
  ...
  return (
    <>
      <Column className="bg-gray_100 font-segoeui items-center mx-[auto] lg:pb-[54px] xl:pb-[62px] pb-[70px] 3xl:pb-[84px] w-[100%]">
        ...
        <Column className="bg-white_A700 font-actor lg:mt-[25px] xl:mt-[29px] mt-[33px] 3xl:mt-[39px] pl-[10px] 3xl:pl-[12px] lg:pl-[7px] xl:pl-[8px] py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] rounded-radius4 shadow-bs w-[35%]">
          ...
          <Stack className="font-sourcesanspro lg:h-[519px] xl:h-[594px] h-[667px] 2xl:h-[668px] 3xl:h-[801px] mb-[10px] 3xl:mb-[12px] lg:mb-[7px] xl:mb-[8px] lg:ml-[10px] xl:ml-[11px] ml-[13px] 3xl:ml-[15px] lg:mt-[10px] xl:mt-[11px] mt-[13px] 3xl:mt-[15px] w-[97%]">
            <Column className="absolute left-[0] top-[0] w-[93%]">
              ...
              <Input
                className="bg-transparent border-0 font-actor font-normal not-italic lg:pl-[12px] xl:pl-[14px] pl-[16px] 3xl:pl-[19px] lg:pr-[27px] xl:pr-[31px] pr-[35px] 3xl:pr-[42px] py-[10px] 3xl:py-[12px] lg:py-[7px] xl:py-[8px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] placeholder:text-gray_301 text-gray_301 w-[100%]"
                wrapClassName="3xl:mt-[9px] border border-gray_400 border-solid lg:mt-[6px] mt-[8px] rounded-radius4 w-[100%] xl:mt-[7px]"
                name="Group216"
              ...
              <Column className="border border-gray_400 border-solid font-actor lg:mt-[6px] xl:mt-[7px] mt-[8px] 3xl:mt-[9px] p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] rounded-radius4 w-[100%]">
            ...
            <Column className="absolute bottom-[0] inset-x-[0] w-[100%]">
